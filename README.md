...
```
git clone https://github.com/openSUSE/cockpit-sap-bone.git
cd cockpit-sap-bone
make
```
...
ln -s `pwd`/dist ~/.local/share/cockpit/cockpit-sap-bone
```
...
remove manually the symlink:
    ...
    rm ~/.local/share/cockpit/cockpit-sap-bone
...
your project after forking from cockpit-sap-bone.
